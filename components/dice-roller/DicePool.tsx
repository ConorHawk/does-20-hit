          ...
          {pendingModifier ? (
            <>
              ...
              <div className="text-sm mt-2">
                Press <kbd className="px-2 py-1 bg-muted rounded text-sm font-mono">ENTER</kbd> to roll • <kbd className="px-2 py-1 bg-muted rounded text-sm font-mono">BACKSPACE</kbd> to edit
              </div>
            </>
          ) : (
            <>
              Press <kbd className="px-2 py-1 bg-muted rounded text-sm font-mono">SPACE</kbd> for 1d20
              {modifier !== 0 && (
